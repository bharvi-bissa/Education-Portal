...
<div>
  ...
  transition: all 0.60s;">
        ...
        <div style="min-height: 100vh;">
        	<div class="alert alert-danger" role="alert" style="font-family: 'Capriola', sans-serif;margin-top: 10%;"><h2 style="margin-top: 2%;text-align: center;"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> Please Sign In to start the course</h2></div>
        </div>
